...
## Resume Here
<!-- 每次必须更新时间戳>
Last updated: 2026-04-28 15:17.
### Current State
<!-- 维护：只留“明天不看会接不上/会做错”的当前状态；完成且不影响下一步就删。目标 5-10 条。 -->
1. Research:
  - P1-P8 clean protocol is defined and running.(prioritize Stage1, P0, P3, P4)
...
2. Job preparation:
  ...
  - LLM & RLHF / Agentic projects planning.
...
- Check current clean queue status: running stage, seed, fold, and logs.
- Verify split metadata before trusting results.
- Start paper writing when P0/P3/P4 experiments finish and generate verified results.
- Investigate evaluation protocol differences between me/CCT-LSTM paper(WACV/IEEE).
...
## 2026-04-28
### Project
Paper preparation / worklog maintenance / experiment monitoring / job preparation.
### Done
